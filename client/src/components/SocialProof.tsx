    ...
    <div className={`flex flex-col items-center gap-3 ${className}`}>
      <div className="flex items-center gap-2">
        <div className="flex -space-x-3">
          <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=80&h=80&fit=crop&crop=face" alt="Étudiant" className="w-10 h-10 rounded-full border-2 border-violet-600 object-cover" />
          <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=80&h=80&fit=crop&crop=face" alt="Étudiante" className="w-10 h-10 rounded-full border-2 border-violet-600 object-cover" />
          <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=80&h=80&fit=crop&crop=face" alt="Étudiant" className="w-10 h-10 rounded-full border-2 border-violet-600 object-cover" />
        </div>
        <span className="bg-violet-600 text-white text-xs font-bold px-2 py-1 rounded-full">+3 400</span>
